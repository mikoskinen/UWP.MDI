...
namespace UWP.MDI.Controls.Microsoft.Toolkit.Uwp.UI.Extensions
{
    /// <summary>
    ...
    public class Mouse
    {
        ...
        public static readonly DependencyProperty CursorProperty =
            DependencyProperty.RegisterAttached("Cursor", typeof(CoreCursorType), typeof(Mouse),
                new PropertyMetadata(CoreCursorType.Arrow, CursorChanged));
        ...
        {
            var cursor = GetCursor((FrameworkElement) sender);
